...
public final class ArrayUtil {
    ...
    public static char[] primitive2Class(Character[] array) {
    ...
    public static boolean[] primitive2Class(Boolean[] array) {
        Preconditions.checkArrayNull(array);
    ...
    public static byte[] primitive2Class(Byte[] array) {
        Preconditions.checkArrayNull(array);
    ...
    public static short[] primitive2Class(Short[] array) {
        Preconditions.checkArrayNull(array);
    ...
    public static int[] primitive2Class(Integer[] array) {
        Preconditions.checkArrayNull(array);
    ...
    public static long[] primitive2Class(Long[] array) {
        Preconditions.checkArrayNull(array);
    ...
    public static float[] primitive2Class(Float[] array) {
        Preconditions.checkArrayNull(array);
